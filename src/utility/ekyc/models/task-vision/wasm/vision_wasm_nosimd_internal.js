...
var ModuleFactory = (() => {
  ...
  return function (ModuleFactory = {}) {
    ...
    function _emscripten_webgl_get_context_attributes(c, a) {
      ...
      var power =
        t['powerPreference'] && emscripten_webgl_power_preferences.indexOf(t['powerPreference'])
      HEAP32[(a + 24) >> 2] = power
    ...
    var _addBoundTextureAsImageToStream = (Module['_addBoundTextureAsImageToStream'] = function () {
      return (_addBoundTextureAsImageToStream = Module['_addBoundTextureAsImageToStream'] =
        Module['asm']['od']).apply(null, arguments)
    })

    var _attachImageListener = (Module['_attachImageListener'] = function () {
      return (_attachImageListener = Module['_attachImageListener'] = Module['asm']['pd']).apply(
        null,
        arguments
      )
    })
    ...
    var _attachImageVectorListener = (Module['_attachImageVectorListener'] = function () {
      return (_attachImageVectorListener = Module['_attachImageVectorListener'] =
    ...
    var _bindTextureToStream = (Module['_bindTextureToStream'] = function () {
      return (_bindTextureToStream = Module['_bindTextureToStream'] = Module['asm']['td']).apply(
        null,
        arguments
      )
    })
    ...
    var _addBoolToInputStream = (Module['_addBoolToInputStream'] = function () {
      return (_addBoolToInputStream = Module['_addBoolToInputStream'] = Module['asm']['xd']).apply(
        null,
        arguments
      )
    })
    ...
    var _addIntToInputStream = (Module['_addIntToInputStream'] = function () {
      return (_addIntToInputStream = Module['_addIntToInputStream'] = Module['asm']['yd']).apply(
        null,
        arguments
      )
    })
    ...
    var _addStringToInputSidePacket = (Module['_addStringToInputSidePacket'] = function () {
      return (_addStringToInputSidePacket = Module['_addStringToInputSidePacket'] =
        Module['asm']['Hd']).apply(null, arguments)
    })

    var _addProtoToInputSidePacket = (Module['_addProtoToInputSidePacket'] = function () {
      return (_addProtoToInputSidePacket = Module['_addProtoToInputSidePacket'] =
        Module['asm']['Id']).apply(null, arguments)
    })

    var _attachBoolListener = (Module['_attachBoolListener'] = function () {
      return (_attachBoolListener = Module['_attachBoolListener'] = Module['asm']['Jd']).apply(
        null,
        arguments
      )
    })
    ...
    var _attachBoolVectorListener = (Module['_attachBoolVectorListener'] = function () {
      return (_attachBoolVectorListener = Module['_attachBoolVectorListener'] =
        Module['asm']['Kd']).apply(null, arguments)
    })

    var _attachDoubleListener = (Module['_attachDoubleListener'] = function () {
      return (_attachDoubleListener = Module['_attachDoubleListener'] = Module['asm']['Ld']).apply(
        null,
        arguments
      )
    })
    ...
    var _attachDoubleVectorListener = (Module['_attachDoubleVectorListener'] = function () {
      return (_attachDoubleVectorListener = Module['_attachDoubleVectorListener'] =
        Module['asm']['Md']).apply(null, arguments)
    })

    var _attachFloatListener = (Module['_attachFloatListener'] = function () {
      return (_attachFloatListener = Module['_attachFloatListener'] = Module['asm']['Nd']).apply(
        null,
        arguments
      )
    })
    ...
    var _attachFloatVectorListener = (Module['_attachFloatVectorListener'] = function () {
      return (_attachFloatVectorListener = Module['_attachFloatVectorListener'] =
        Module['asm']['Od']).apply(null, arguments)
    })

    var _attachIntListener = (Module['_attachIntListener'] = function () {
      return (_attachIntListener = Module['_attachIntListener'] = Module['asm']['Pd']).apply(
        null,
        arguments
      )
    })
    ...
    var _attachStringListener = (Module['_attachStringListener'] = function () {
      return (_attachStringListener = Module['_attachStringListener'] = Module['asm']['Rd']).apply(
        null,
        arguments
      )
    })
    ...
    var _attachStringVectorListener = (Module['_attachStringVectorListener'] = function () {
      return (_attachStringVectorListener = Module['_attachStringVectorListener'] =
        Module['asm']['Sd']).apply(null, arguments)
    })

    var _attachProtoListener = (Module['_attachProtoListener'] = function () {
      return (_attachProtoListener = Module['_attachProtoListener'] = Module['asm']['Td']).apply(
        null,
        arguments
      )
    })
    ...
    var _attachProtoVectorListener = (Module['_attachProtoVectorListener'] = function () {
      return (_attachProtoVectorListener = Module['_attachProtoVectorListener'] =
        Module['asm']['Ud']).apply(null, arguments)
    })

    var _getGraphConfig = (Module['_getGraphConfig'] = function () {
      return (_getGraphConfig = Module['_getGraphConfig'] = Module['asm']['Vd']).apply(
        null,
        arguments
      )
    })
    ...
    var _clearSubgraphs = (Module['_clearSubgraphs'] = function () {
      return (_clearSubgraphs = Module['_clearSubgraphs'] = Module['asm']['Wd']).apply(
        null,
        arguments
      )
    })
    ...
    var _pushBinarySubgraph = (Module['_pushBinarySubgraph'] = function () {
      return (_pushBinarySubgraph = Module['_pushBinarySubgraph'] = Module['asm']['Xd']).apply(
        null,
        arguments
      )
    })
    ...
    var _pushTextSubgraph = (Module['_pushTextSubgraph'] = function () {
      return (_pushTextSubgraph = Module['_pushTextSubgraph'] = Module['asm']['Yd']).apply(
        null,
        arguments
      )
    })
    ...
    var _changeBinaryGraph = (Module['_changeBinaryGraph'] = function () {
      return (_changeBinaryGraph = Module['_changeBinaryGraph'] = Module['asm']['Zd']).apply(
        null,
        arguments
      )
    })
    ...
    var _changeTextGraph = (Module['_changeTextGraph'] = function () {
      return (_changeTextGraph = Module['_changeTextGraph'] = Module['asm']['_d']).apply(
        null,
        arguments
      )
    })
    ...
    var _bindTextureToCanvas = (Module['_bindTextureToCanvas'] = function () {
      return (_bindTextureToCanvas = Module['_bindTextureToCanvas'] = Module['asm']['be']).apply(
        null,
        arguments
      )
    })
    ...
    var _requestShaderRefreshOnGraphChange = (Module['_requestShaderRefreshOnGraphChange'] =
      function () {
        return (_requestShaderRefreshOnGraphChange = Module['_requestShaderRefreshOnGraphChange'] =
          Module['asm']['ce']).apply(null, arguments)
      })

    var _waitUntilIdle = (Module['_waitUntilIdle'] = function () {
      return (_waitUntilIdle = Module['_waitUntilIdle'] = Module['asm']['de']).apply(
        null,
        arguments
      )
    })
    ...
    var ___getTypeName = (Module['___getTypeName'] = function () {
      return (___getTypeName = Module['___getTypeName'] = Module['asm']['ge']).apply(
        null,
        arguments
      )
    })
