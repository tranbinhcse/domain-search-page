  ...
  <div v-if="domain" class="max-w-7xl mx-auto mt-5">
        ...
        -->
          <div class="pt-1.5">
            ...
            <p class="text-sm text-gray-500">
              Ngày hết hạn <time class="font-medium">{{ domain.expires }}</time>
            </p>
          </div>
        </div>
        <div
    ...
    <Box>
      ...
      <dl class="mx-auto flex divide-x divide-gray-50 mb-[40px] mt-5">
          ...
          <dd v-if="contact" class="w-full flex text-sm text-gray-900 cursor-pointer">
            <dl>
              <div class="px-1 py-1 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                ...
                <dd class="mt-1 text-sm font-medium leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                  {{ contact.name }}
                </dd>
              </div>
              <div class="px-1 py-1 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              ...
              <div class="px-1 py-1 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                ...
                <dd
                  v-if="contact.address2"
                  class="mt-1 text-sm font-medium leading-6 text-gray-700 sm:col-span-2 sm:mt-0"
                >
                  {{ contact.address2 }}
                </dd>
              </div>
        ...
        <div
          class="flex flex-col items-baseline gap-x-4 gap-y-2 bg-white px-4 py-10 sm:px-6 xl:px-8"
        >
      ...
      <Heading
        text="Dịch vụ liên quan"
        class="text-primary uppercase text-lg border-b-2 border-gray-50 pb-2 mb-2"
      />
      <div
        class="mx-auto mt-12 grid max-w-sm grid-cols-1 gap-x-8 gap-y-10 sm:max-w-none sm:grid-cols-4 lg:grid-cols-7"
      >
        <div
