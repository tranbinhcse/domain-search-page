          ...
          <a-row :gutter="8">
              <a-col :span="12">
                      <a-form-item field="password" label="Mật khẩu"  :validate-trigger="['change','input']" >
                          <a-input-password v-model="form.password" placeholder="Vui lòng nhập mật khẩu bảo vệ tại khoản..."  @change="handlePasswordMatch"/>
                      </a-form-item>
              </a-col>
              <a-col :span="12">
                  <a-form-item field="password2" label="Nhập lại mật khẩu" :validate-trigger="['change','input']"  >
                    <a-input-password v-model="form.password2" placeholder="Vui lòng nhập lại mật khẩu" @change="handlePasswordMatch" />
                    </a-form-item>
          ...
          <a-row :gutter="8">
              <a-col :span="12">
                  <a-form-item field="city" label="Quận/Huyện"  :validate-trigger="['change','input']" >
                      <a-select allow-search v-model="form.city" placeholder="Vui lòng chọn Quận/Huyện..."  @change="handleGetWards(form.city)" >
...
const { t } = useI18n();
      ...
      const rules = reactive({
          ...
          phonenumber: [
              ...
              { required: true, message:'Yêu cầu cung cấp ngày sinh' },
          ],
          nationalid: [
