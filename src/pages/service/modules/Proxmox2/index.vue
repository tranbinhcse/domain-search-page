    ...
    <a-tabs size="large" @change="handleTabClick" hide-content="true">
        ...
        <a-tabs size="large" hide-tab="true" position="bottom" :active-key="tabActive" >
            ...
            <div class="flex gap-6 mb-5 justify-center items-center flex-auto" v-if="vmdetails.bandwidth">
                <a-statistic title="Bandwidth Usage" :value="$unitFormat(vmdetails?.bandwidth?.data_sent)" show-group-separator  class="bg-white p-6 rounded flex-auto" animation>
                    <template #suffix>
                        GB
                    </template>
                </a-statistic>
                <a-statistic title="RAM Usage" :value="50.52" :precision="2" :value-style="{ color: '#0fbf60' }"  class="bg-white p-6 rounded flex-auto">
                    <template #prefix>
                        <icon-arrow-rise />
                    </template>
                ...
                <div class="bg-white p-6 rounded flex-auto arco-statistic">
                    ...
                    <div class="arco-statistic-content">
                        <div class="arco-statistic-value">
                            <span class="arco-statistic-value-integer">{{ convertToDayAndTime(vmdetails?.uptime) }}</span>
                        </div>
                    </div>
             ...
             <div class="bg-white p-4 rounded">
                ...
                <a-descriptions title="User Info" :column="{xs:1, md:3, lg:3}">
                    ...
                    <a-descriptions-item span="1" label="Bandwidth">
                       Unlimited
                    </a-descriptions-item>
