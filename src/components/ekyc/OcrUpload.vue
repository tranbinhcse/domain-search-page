  ...
  <div class="relative">
    <div class="">
      <div class="flex items-center justify-center w-full">
        <label
          :for="`dropzone-file-${type}`"
          class="flex flex-col items-center justify-center w-full h-42 overflow-hidden border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600"
        >
          <div v-if="!file" class="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            <p class="mb-2 text-sm text-gray-500 dark:text-gray-400">
              <span class="font-semibold">Chọn ảnh</span> hoặc kéo thả
            </p>
    ...
    <div
      v-show="loading"
      class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-20 bg-slate-500/20 dark:bg-gray-700/20 w-full h-full flex justify-center items-center"
    >
