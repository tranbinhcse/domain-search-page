    ...
    const timer = setIntervalAsync(async () => {
        ...
        if (!setUpFaceDetectionCallBack.value) {
            ...
            faceMesh.onResults(async (results) => {
                ...
                if (results.multiFaceLandmarks && results.multiFaceLandmarks.length === 0 && stepRef.value !== 0) {
...
<template>
    <div class="flex flex-col gap-4 text-center">
        ...
        <div>
            <video style=" max-width: 100%;" v-show="!isPhotoTaken" ref="video" webkit-playsinline playsinline autoplay
                :onPlay="handleGetUserMedia"></video>
