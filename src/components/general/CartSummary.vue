                ...
                <div class="flex h-full flex-col overflow-y-scroll bg-white shadow-xl relative">
                  <div class="flex-1 overflow-y-auto px-4 py-6 sm:px-6">
                    ...
                    <div class="mt-8">
                      <div class="flow-root">
                        <div
                          class="text-center absolute top-0 bottom-0 left-0 right-0 bg-white/40 flex justify-center items-center"
                          v-if="quoteLoading"
                        >
                        ...
                        <ul role="list" class="divide-y divide-gray-200" v-if="cartQuote">
                          <template
                            v-for="(product, key) in cartQuote?.items"
                            :key="key"
                            class="flex py-6"
                          >
                  ...
                  <div
                    ...
                    v-if="cartQuote && cartQuote?.items.length > 0"
                  >
  ...
  <div v-if="cartItems.length > 0" class="fixed inset-x-0 bottom-0 bg-white px-4 py-4 sm:px-6">
    <div class="max-w-7xl mx-auto flex justify-center">
      ...
      <div>
        <a
          href="#"
          @click.stop="handleSummaryCart()"
          class="flex items-center justify-center rounded-md border border-transparent bg-primary px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-green-700 min-w-80 pointer"
          >Xem giỏ hàng</a
        >
      </div>
    </div>
