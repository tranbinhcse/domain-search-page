    ...
    <div class="section-popular-domain">
      <ul role="list" class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        <li
          ...
          :key="domain.domain"
          class="col-span-1 flex flex-col divide-y divide-gray-200 rounded-lg bg-white text-left border"
        >
          <div class="flex flex-1 flex-col p-8">
            ...
            <dl class="mt-1 flex flex-grow flex-col justify-between">
              ...
              <dd class="mt-3">
                ...
                <span class="font-bold text-3xl text-red-500">{{ $currency(domain.register) }}</span
                ><span>đ/năm</span>
              </dd>
              <div class="mt-4"></div>
