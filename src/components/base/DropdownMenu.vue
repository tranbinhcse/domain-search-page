<template>
  <Menu as="div" class="relative inline-block">
    <div>
      <MenuButton
        class="inline-flex w-full justify-center gap-x-1.5 rounded-md bg-white px-4 py-3 text-sm text-gray-900 shadow-sm hover:bg-gray-50"
      >
        {{ menus[modelValue] }}
    ...
    >
      ...
      >
        <MenuItem v-for="(value, key) in menus" :key="key">
          <button
