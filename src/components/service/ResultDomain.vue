<template>
  <div v-for="domain in domains" :key="domain.id">
    <div
      ...
      class="px-6 bg-white divider-y flex flex-col"
      :class="[
        domain.isFeatured ? 'featured py-10 bg-primary/30  py-6  shadow' : '',
  ...
  <div v-for="domain in domains" :key="domain.id">
    <div
      ...
      :class="[
        ...
        domain.isFeatured ? 'featured py-10 bg-primary/10  py-6  shadow' : '',
        domain.status == 'inCheck'
          ? 'check-domain'
          : domain.status == 'ok'
            ? 'found-domain'
